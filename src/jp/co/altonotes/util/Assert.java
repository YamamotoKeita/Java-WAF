...
/**
 * 値の検証を行い、不正な場合ExceptionをThrowする<br>
 * org.springframework.util.Assert からコピーして一部改造<br>
 *
...
public abstract class Assert {
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (Checker.isNotEmpty(textToSearch) && Checker.isNotEmpty(substring) &&
